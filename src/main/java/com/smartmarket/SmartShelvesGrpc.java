...
public final class SmartShelvesGrpc {
  ...
  public static final String SERVICE_NAME = "com.smartmarket.SmartShelves";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.smartmarket.SmartShelvesOuterClass.ProductRequest,
      com.smartmarket.SmartShelvesOuterClass.ProductInfo> getGetProductInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetProductInfo",
      requestType = com.smartmarket.SmartShelvesOuterClass.ProductRequest.class,
      responseType = com.smartmarket.SmartShelvesOuterClass.ProductInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.smartmarket.SmartShelvesOuterClass.ProductRequest,
      com.smartmarket.SmartShelvesOuterClass.ProductInfo> getGetProductInfoMethod() {
    io.grpc.MethodDescriptor<com.smartmarket.SmartShelvesOuterClass.ProductRequest, com.smartmarket.SmartShelvesOuterClass.ProductInfo> getGetProductInfoMethod;
      ...
      synchronized (SmartShelvesGrpc.class) {
        if ((getGetProductInfoMethod = SmartShelvesGrpc.getGetProductInfoMethod) == null) {
          SmartShelvesGrpc.getGetProductInfoMethod = getGetProductInfoMethod = 
              io.grpc.MethodDescriptor.<com.smartmarket.SmartShelvesOuterClass.ProductRequest, com.smartmarket.SmartShelvesOuterClass.ProductInfo>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.smartmarket.SmartShelves", "GetProductInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smartmarket.SmartShelvesOuterClass.ProductRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smartmarket.SmartShelvesOuterClass.ProductInfo.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.smartmarket.SmartShelvesOuterClass.StockRequest,
      com.smartmarket.SmartShelvesOuterClass.StockAlert> getStreamLowStockAlertsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamLowStockAlerts",
      requestType = com.smartmarket.SmartShelvesOuterClass.StockRequest.class,
      responseType = com.smartmarket.SmartShelvesOuterClass.StockAlert.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.smartmarket.SmartShelvesOuterClass.StockRequest,
      com.smartmarket.SmartShelvesOuterClass.StockAlert> getStreamLowStockAlertsMethod() {
    io.grpc.MethodDescriptor<com.smartmarket.SmartShelvesOuterClass.StockRequest, com.smartmarket.SmartShelvesOuterClass.StockAlert> getStreamLowStockAlertsMethod;
      ...
      synchronized (SmartShelvesGrpc.class) {
        if ((getStreamLowStockAlertsMethod = SmartShelvesGrpc.getStreamLowStockAlertsMethod) == null) {
          SmartShelvesGrpc.getStreamLowStockAlertsMethod = getStreamLowStockAlertsMethod = 
              io.grpc.MethodDescriptor.<com.smartmarket.SmartShelvesOuterClass.StockRequest, com.smartmarket.SmartShelvesOuterClass.StockAlert>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "com.smartmarket.SmartShelves", "StreamLowStockAlerts"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smartmarket.SmartShelvesOuterClass.StockRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smartmarket.SmartShelvesOuterClass.StockAlert.getDefaultInstance()))
  ...
  public static abstract class SmartShelvesImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getProductInfo(com.smartmarket.SmartShelvesOuterClass.ProductRequest request,
        io.grpc.stub.StreamObserver<com.smartmarket.SmartShelvesOuterClass.ProductInfo> responseObserver) {
      asyncUnimplementedUnaryCall(getGetProductInfoMethod(), responseObserver);
    }

    /**
     */
    public void streamLowStockAlerts(com.smartmarket.SmartShelvesOuterClass.StockRequest request,
        io.grpc.stub.StreamObserver<com.smartmarket.SmartShelvesOuterClass.StockAlert> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.smartmarket.SmartShelvesOuterClass.ProductRequest,
                com.smartmarket.SmartShelvesOuterClass.ProductInfo>(
                  this, METHODID_GET_PRODUCT_INFO)))
          .addMethod(
            getStreamLowStockAlertsMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                com.smartmarket.SmartShelvesOuterClass.StockRequest,
                com.smartmarket.SmartShelvesOuterClass.StockAlert>(
  ...
  public static final class SmartShelvesBlockingStub extends io.grpc.stub.AbstractStub<SmartShelvesBlockingStub> {
    ...
    /**
     */
    public com.smartmarket.SmartShelvesOuterClass.ProductInfo getProductInfo(com.smartmarket.SmartShelvesOuterClass.ProductRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.smartmarket.SmartShelvesOuterClass.StockAlert> streamLowStockAlerts(
        com.smartmarket.SmartShelvesOuterClass.StockRequest request) {
  ...
  public static final class SmartShelvesFutureStub extends io.grpc.stub.AbstractStub<SmartShelvesFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.smartmarket.SmartShelvesOuterClass.ProductInfo> getProductInfo(
        com.smartmarket.SmartShelvesOuterClass.ProductRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT_INFO:
          serviceImpl.getProductInfo((com.smartmarket.SmartShelvesOuterClass.ProductRequest) request,
              (io.grpc.stub.StreamObserver<com.smartmarket.SmartShelvesOuterClass.ProductInfo>) responseObserver);
          break;
        case METHODID_STREAM_LOW_STOCK_ALERTS:
          serviceImpl.streamLowStockAlerts((com.smartmarket.SmartShelvesOuterClass.StockRequest) request,
              (io.grpc.stub.StreamObserver<com.smartmarket.SmartShelvesOuterClass.StockAlert>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmartShelvesBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.smartmarket.SmartShelvesOuterClass.getDescriptor();
    }
