...
public final class SmartCheckoutGrpc {
  ...
  public static final String SERVICE_NAME = "SmartCheckout";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<SmartCheckoutOuterClass.PaymentRequest,
      SmartCheckoutOuterClass.PaymentResponse> getProcessPaymentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ProcessPayment",
      requestType = SmartCheckoutOuterClass.PaymentRequest.class,
      responseType = SmartCheckoutOuterClass.PaymentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<SmartCheckoutOuterClass.PaymentRequest,
      SmartCheckoutOuterClass.PaymentResponse> getProcessPaymentMethod() {
    io.grpc.MethodDescriptor<SmartCheckoutOuterClass.PaymentRequest, SmartCheckoutOuterClass.PaymentResponse> getProcessPaymentMethod;
      ...
      synchronized (SmartCheckoutGrpc.class) {
        if ((getProcessPaymentMethod = SmartCheckoutGrpc.getProcessPaymentMethod) == null) {
          SmartCheckoutGrpc.getProcessPaymentMethod = getProcessPaymentMethod = 
              io.grpc.MethodDescriptor.<SmartCheckoutOuterClass.PaymentRequest, SmartCheckoutOuterClass.PaymentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SmartCheckout", "ProcessPayment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  SmartCheckoutOuterClass.PaymentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  SmartCheckoutOuterClass.PaymentResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<SmartCheckoutOuterClass.ScanRequest,
      SmartCheckoutOuterClass.ScannedItem> getStreamScannedItemsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamScannedItems",
      requestType = SmartCheckoutOuterClass.ScanRequest.class,
      responseType = SmartCheckoutOuterClass.ScannedItem.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<SmartCheckoutOuterClass.ScanRequest,
      SmartCheckoutOuterClass.ScannedItem> getStreamScannedItemsMethod() {
    io.grpc.MethodDescriptor<SmartCheckoutOuterClass.ScanRequest, SmartCheckoutOuterClass.ScannedItem> getStreamScannedItemsMethod;
      ...
      synchronized (SmartCheckoutGrpc.class) {
        if ((getStreamScannedItemsMethod = SmartCheckoutGrpc.getStreamScannedItemsMethod) == null) {
          SmartCheckoutGrpc.getStreamScannedItemsMethod = getStreamScannedItemsMethod = 
              io.grpc.MethodDescriptor.<SmartCheckoutOuterClass.ScanRequest, SmartCheckoutOuterClass.ScannedItem>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "SmartCheckout", "StreamScannedItems"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  SmartCheckoutOuterClass.ScanRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  SmartCheckoutOuterClass.ScannedItem.getDefaultInstance()))
  ...
  public static abstract class SmartCheckoutImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void processPayment(SmartCheckoutOuterClass.PaymentRequest request,
        io.grpc.stub.StreamObserver<SmartCheckoutOuterClass.PaymentResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getProcessPaymentMethod(), responseObserver);
    }

    /**
     */
    public void streamScannedItems(SmartCheckoutOuterClass.ScanRequest request,
        io.grpc.stub.StreamObserver<SmartCheckoutOuterClass.ScannedItem> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                SmartCheckoutOuterClass.PaymentRequest,
                SmartCheckoutOuterClass.PaymentResponse>(
                  this, METHODID_PROCESS_PAYMENT)))
          .addMethod(
            getStreamScannedItemsMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                SmartCheckoutOuterClass.ScanRequest,
                SmartCheckoutOuterClass.ScannedItem>(
  ...
  public static final class SmartCheckoutBlockingStub extends io.grpc.stub.AbstractStub<SmartCheckoutBlockingStub> {
    ...
    /**
     */
    public SmartCheckoutOuterClass.PaymentResponse processPayment(SmartCheckoutOuterClass.PaymentRequest request) {
    ...
    /**
     */
    public java.util.Iterator<SmartCheckoutOuterClass.ScannedItem> streamScannedItems(
        SmartCheckoutOuterClass.ScanRequest request) {
  ...
  public static final class SmartCheckoutFutureStub extends io.grpc.stub.AbstractStub<SmartCheckoutFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<SmartCheckoutOuterClass.PaymentResponse> processPayment(
        SmartCheckoutOuterClass.PaymentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS_PAYMENT:
          serviceImpl.processPayment((SmartCheckoutOuterClass.PaymentRequest) request,
              (io.grpc.stub.StreamObserver<SmartCheckoutOuterClass.PaymentResponse>) responseObserver);
          break;
        case METHODID_STREAM_SCANNED_ITEMS:
          serviceImpl.streamScannedItems((SmartCheckoutOuterClass.ScanRequest) request,
              (io.grpc.stub.StreamObserver<SmartCheckoutOuterClass.ScannedItem>) responseObserver);
          break;
        default:
  ...
  private static abstract class SmartCheckoutBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return SmartCheckoutOuterClass.getDescriptor();
    }
